...
# # Step 6: Save preprocessed data for later use, including dates
# np.savez('preprocessed_data.npz', 
#          X_train=X_train, 
#          X_test=X_test, 
#          y_train=y_train, 
#          y_test=y_test, 
#          dates=data['Date'].values[sequence_length:])  # Ensure dates align with the created sequences
...
# # Step 5: Use TimeSeriesSplit for robust validation
...
sequence_length = 36  # Increased sequence length for better learning
X, y = create_sequences(scaled_data, sequence_length)
