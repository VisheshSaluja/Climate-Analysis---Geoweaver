...
# # Step 2: Build the improved LSTM model
# model = Sequential()
# model.add(Bidirectional(LSTM(100, return_sequences=True, input_shape=(X_train.shape[1], 1), kernel_regularizer=l2(0.001))))
...
# # Step 6: Save the model and training history
# model.save('improved_lstm_model.h5')
...
model = Sequential()
model.add(Bidirectional(LSTM(128, return_sequences=True, input_shape=(X_train.shape[1], 1), kernel_regularizer=l2(0.001))))
